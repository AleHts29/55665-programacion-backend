...
import { generateUserErrorInfoSP, generateUserErrorInfoENG } from "../services/errors/messages/user-creation-error.message.js";
...
export const saveUser = (req, res) => {
    ...
    if (!first_name || !email) {
        ...
        CustomError.createError({
            ...
            cause: generateUserErrorInfoSP({ first_name, email }),
